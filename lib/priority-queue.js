...
module.exports = class PriorityQueue {
  ...
  enqueue(item) {
    ...
    this._queue.push(item) // TODO: check if enqueue can be called with no arg
    this._siftUp(this._queue.length - 1)
  }

  /**
   * Removes and returns the item from the beginning of the PriorityQueue
   * @public
  ...
  /**
   * Returns the item at the beginning of the PriorityQueue
   * @public
  ...
  /**
   * Returns true if the PriorityQueue is empty, false if not
   * @public
  ...
  /**
   * PRIVATE - Calls the comparator function on two items to compare
   * @private
   * @param {*} a - First item to compare
   * @param {*} b - Second item to compare
   * @returns {Number} - Number used for sort function
  ...
  /**
   * PRIVATE - Recursively sifts an item at a given index higher in the queue if possible
   * @private
  ...
  /**
   * PRIVATE - Recursively sifts an item at a given index lower in the queue if possible
   * @private
